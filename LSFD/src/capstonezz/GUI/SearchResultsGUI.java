...
public class SearchResultsGUI extends JPanel implements ActionListener {
    ...
    public SearchResultsGUI(Color color, int parentWidth, int parentHeight, SearchResults results){
        ...
        addressLabel.setFont(addressLabel.getFont().deriveFont(24f));
        numberLabel.setFont(numberLabel.getFont().deriveFont(24f));
    ...
    private void init(Color color){
        ...
        address.addCaretListener((CaretEvent ce) -> {
            Linker.getLinker().getHome().getSearch().getAddressSearch().setText(address.getText());
        });
        ...
        number.addCaretListener((CaretEvent ce) -> {
            Linker.getLinker().getHome().getSearch().getNumberSearch().setText(number.getText());
        });
        ...
        initiateSearch.setToolTipText("Begin searching with entered criteria");
        c = new GridBagConstraints();
        c.gridx = 1;
        c.gridy = 8;
        c.weighty = 0;
    ...
    protected void paintComponent(Graphics g){
        ...
        g2d.fillRect(0, getHeight() - 17, width, 15);
    }
    
    @Override
    public void actionPerformed(ActionEvent e) {
        displayLoadingBar(true);
        new SearchTask(searchresults, this);
    }
