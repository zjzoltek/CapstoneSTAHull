...
public class Linker {
    ...
    public class GracefulExit implements ActionListener{
    ...
    public class HomeTaker implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            backStack.push(currPanel);
    ...
    public class EditCreate implements ActionListener{
    ...
    public class EditExit implements ActionListener{
        private final FormEntity controller;
